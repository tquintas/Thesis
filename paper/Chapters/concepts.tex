...
objectivo de repetir

obecessão

copiar vs espelhar

repetições alternadas, reversas e ciclicas

hesitancia e frustraçao em sequencias longas e complexas

repetição anula o progresso temporal

qual é a motivação para a repetição?

a diferença é o que faz distinguir a repetição A da repetição B

a diferença nao é inconsistencia, a inconsistência é caos
...
\Subsubsection{Aceleração e Desaceleração}
